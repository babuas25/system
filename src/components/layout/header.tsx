...
import { LogOut, Menu, ChevronDown, UserCircle, Sun, Moon, Monitor } from 'lucide-react'
        ...
        <div className="flex items-center space-x-3">
          ...
          {showUserActions && status === 'loading' ? (
            ...
            <div className="relative" ref={userDropdownRef}>
              ...
              >
                <div
                  className={`w-6 h-6 backdrop-blur-sm rounded-full flex items-center justify-center border ${themeColors.primary.replace('bg-', 'bg-').replace('/90', '/20')} ${themeColors.primaryBorder}`}
                >
